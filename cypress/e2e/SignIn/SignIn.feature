Feature: Authentication
 ...
 Given I open the the Sign in page
  ...
  Scenario: The user isn't Signed in with invalid Email and valid Password
    ...
    Then I see the user is not signed in and the validation message displayed for email
  ...
  Scenario: The user isn't Signed in with valid Email and blank Password field
    ...
    Then I see the user is not signed in and the validation message displayed for blank password
  ...
  Scenario: The user isn't Signed in with blank password and Email fields
    ...
    Then I see the user is not signed in and the credentials validation messages displayed
